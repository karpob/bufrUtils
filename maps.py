...
def plotMap(lat, lon, data, title, graphicName, plotRange = None, units='', colorScheme = 'viridis', projectionSelected = ccrs.PlateCarree(), poiLats = None, poiLons = None):
    ...
    if( poiLats ):
        ax1.plot(poiLats, poiLons, color = 'black', linewidth =0, marker='x', transform=ccrs.Geodetic())
...
def plotMapHist(lat, lon, data, title, graphicName, plotRange = None, units='', colorScheme = 'viridis', projectionSelected = ccrs.PlateCarree(), poiLats = None, poiLons = None ):
    ...
    if( poiLats ):
        print(poiLats,poiLons)
        ax1.scatter(poiLons, poiLats, color = 'black', marker='x', transform=ccrs.Geodetic())
    statString = "Mean={:10.4f} Standard Deviation={:10.4f} Min={:10.4f} Max={:10.4f}  ".format( data.mean(), data.std(ddof=1), data.min(), data.max() )
